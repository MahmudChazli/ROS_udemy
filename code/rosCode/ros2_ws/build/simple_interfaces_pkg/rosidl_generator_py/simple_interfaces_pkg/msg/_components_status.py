...
class ComponentsStatus(metaclass=Metaclass_ComponentsStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.camera_on = kwargs.get('camera_on', bool())
        self.lidar_on = kwargs.get('lidar_on', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.camera_on != other.camera_on:
            return False
        if self.lidar_on != other.lidar_on:
            return False
    ...
    @builtins.property
    def camera_on(self):
        """Message field 'camera_on'."""
        return self._camera_on

    @camera_on.setter
    def camera_on(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'camera_on' field must be of type 'bool'"
        self._camera_on = value

    @builtins.property
    def lidar_on(self):
        """Message field 'lidar_on'."""
        return self._lidar_on

    @lidar_on.setter
    def lidar_on(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'lidar_on' field must be of type 'bool'"
        self._lidar_on = value
