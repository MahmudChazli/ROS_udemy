...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComponentsStatus_message_member_array[4] = {
  {
    ...
    offsetof(simple_interfaces_pkg::msg::ComponentsStatus, camera_on),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simple_interfaces_pkg::msg::ComponentsStatus, lidar_on),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simple_interfaces_pkg::msg::ComponentsStatus, motor_on),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simple_interfaces_pkg::msg::ComponentsStatus, debug_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
